...
<div <?php post_class("teaser"); ?>><!-- template-file: teaser-document-mini.php -->
  <div class="row">
    ...
    <div class="col-md-3 text-md-right">
      <?php if (!empty($src)): ?>
        <a href="<?php echo esc_url($src); ?>" class="btn btn-primary btn-sm" download="<?php echo $filename; ?>" aria-labelledby="<?php the_ID(); ?>"><i aria-hidden="true" class="fa fa-fw fa-download"></i>Download</a>
      <?php endif; ?>
    </div>
  </div>
</div>
