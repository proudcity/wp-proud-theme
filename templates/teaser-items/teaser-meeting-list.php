...
?>
  <div class="row">
    ...
    <div class="col-xs-9 col-md-10">
        <p class="margin-top-none"><time class="start-time"><?php echo date_format($datetime, $time_format) ?></time>
        <?php if(!empty($location_name)) :?>
          <i aria-hidden="true" class="fa fa-caret-right icon-even-width text-center"></i> <span class="location"><?php echo esc_attr($location_name); ?></span>
        <?php endif; ?></p>
      </ul>
      <?php if($is_upcoming): ?>
