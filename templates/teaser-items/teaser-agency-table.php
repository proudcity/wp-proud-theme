<tr><!-- template-file: teaser-agency-table.php -->
  ...
  <td><?php if( !empty( $meta['phone'][0] ) && empty( $this->hide['phone'] ) ): ?>
    <?php echo sprintf( '<a href="%s"><i aria-hidden="true" class="fa fa-fw fa-phone"></i>%s</a>', esc_url( 'tel:' . $meta['phone'][0] ) , $meta['phone'][0] ); ?>
  <?php endif; ?></td>
  ...
  <td>
    <?php if ( empty($this->hide['social']) ): ?>
      <?php if( !empty( $meta['social_facebook'][0] ) ): ?><a href="<?php echo esc_url( $meta['social_facebook'][0] ) ?>"><i aria-hidden="true" class="fa fa-fw fa-facebook-square"></i></a><?php endif; ?>
      <?php if( !empty( $meta['social_twitter'][0] ) ): ?><a href="<?php echo esc_url( $meta['social_twitter'][0] ) ?>"><i aria-hidden="true" class="fa fa-fw fa-twitter-square"></i></a><?php endif; ?>
    <?php endif; ?>
  </td>
