...
include_once __DIR__ . '/so-pagebuilder/so-pagebuilder.php';
...
?>
  ...
  <style type="text/css">
    ...
    @media screen and (min-width: <?php echo $proudSCSS['nav-fixed-top-min'] ?>) {
      ...
      .scrolled.proud-navbar-transparent .navbar-external,
      .search-active.proud-navbar-transparent .navbar-external,
      .active-311.proud-navbar-transparent .navbar-external {
    ...
    <?php elseif ($navbar_background == '#FFFFFF' || $navbar_background == '#ffffff'): ?>.navbar.navbar-external {
    ...
    ?>@media screen and (min-width: <?php echo $proudSCSS['nav-fixed-bottom-min'] ?>) {
      ...
      .navbar-external .below .navbar-nav> :not(.active)>a:focus {
        <?php if ($is_navbar_active_light): ?><?php if ($is_navbar_active_extra_light): ?>color: #434343 !important;
        <?php else: ?>color: #101010 !important;
        <?php endif; ?><?php else: ?>color: #fff !important;
        <?php endif; ?>
      }
    ...
    .gform_button:hover {
      ...
      <?php endif; ?><?php else: ?>color: #fff;
      <?php endif; ?>
    }

    .gform_wrapper .button,
    .gform-theme.gform-theme--framework.gform_wrapper .button:where(:not(.gform-theme-no-framework):not(.gform-theme__disable):not(.gform-theme__disable *):not(.gform-theme__disable-framework):not(.gform-theme__disable-framework *)),
    .gform-theme.gform-theme--framework.gform_wrapper .gform-theme-button:not(.gform-theme-button--simple):where(:not(.gform-theme-no-framework):not(.gform-theme__disable):not(.gform-theme__disable *):not(.gform-theme__disable-framework):not(.gform-theme__disable-framework *)),
    .gform-theme.gform-theme--framework.gform_wrapper :where(:not(.mce-splitbtn))>button:not([id*="mceu_"]):not(.mce-open):not(.gform-theme-button--simple):where(:not(.gform-theme-no-framework):not(.gform-theme__disable):not(.gform-theme__disable *):not(.gform-theme__disable-framework):not(.gform-theme__disable-framework *)),
